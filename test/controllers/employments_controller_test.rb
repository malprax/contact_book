...
class EmploymentsControllerTest < ActionController::TestCase
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post :create, employment: { image: @employment.image, info: @employment.info, title: @employment.title, writer: @employment.writer }
    end
  ...
  test "should update employment" do
    patch :update, id: @employment, employment: { image: @employment.image, info: @employment.info, title: @employment.title, writer: @employment.writer }
    assert_redirected_to employment_path(assigns(:employment))
  end
